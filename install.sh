...
echo "====================================================="
echo ""
echo "⚠️ Не забудьте открыть порт 56000 в межсетевом экране!!!"
echo "Межсетевой экран -> Добавить правило -> Порт назначения равен 56000. ✅ Включить правило. -> Сохранить"
